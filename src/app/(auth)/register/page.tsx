            ...
            {step === "register" && (
              <motion.form key="register-form" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <input className="input" type="text" placeholder="Hari Krishna" value={form.fullName} onChange={set("fullName")} required />
                </div>
                <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
                  <div>
                    ...
                    <input className="input" type="text" placeholder="SRGEC" value={form.college} onChange={set("college")} />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: 13, fontWeight: 500, color: "#a1a1aa", marginBottom: 7 }}>Branch</label>
                    <input className="input" type="text" placeholder="CSE" value={form.branch} onChange={set("branch")} />
                  </div>
                </div>
