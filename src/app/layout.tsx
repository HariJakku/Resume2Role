...
export const metadata: Metadata = {
  ...
  keywords: ['resume to role', 'campus placement preparation', 'mock interview', 'ATS resume checker', 'B.Tech placement prep', 'coding practice', 'MNC interview preparation' , 'Resume 2 Role', 'lihan','jakku kumarswami' ],
  verification: {
